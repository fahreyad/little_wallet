<?php $__env->startSection('title', 'Edit Profit'); ?>
<?php $__env->startSection('page-title', 'Edit Profit'); ?>
...
<div class="card">
    <div class="card-body p-4 p-md-5">
        <form method="POST" action="<?php echo e(route('profits.update', $profit)); ?>">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/profits/edit.blade.php ENDPATH**/ ?>