<?php $__env->startSection('title', 'Monthly Report: ' . $month); ?>
<?php $__env->startSection('page-title', 'Monthly Report: ' . $month); ?>

<?php $__env->startSection('content'); ?>
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <a href="<?php echo e(route('reports.index')); ?>" class="text-decoration-none text-secondary small"><i class="bi bi-arrow-left"></i> Back to reports</a>
        <h1 class="h3 fw-bold mt-1 mb-0">Monthly Report: <?php echo e($month); ?></h1>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <p class="card-text display-6"><?php echo e(number_format($totals['amount'], 2)); ?></p>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <p class="card-text display-6"><?php echo e(number_format($totals['total_amount'], 2)); ?></p>
                    </div>
                    <div class="bg-white bg-opacity-25 rounded-3 p-2">
...
<div class="card">
    <div class="card-header bg-transparent pt-4 pb-0 border-bottom-0">
        ...
        <p class="text-secondary small">All profit entries for <?php echo e($month); ?></p>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/reports/monthly.blade.php ENDPATH**/ ?>